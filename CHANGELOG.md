...
- resource/gitlab_repository_file:  [Update `encoding` to be a required field](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/205ab89a82b82bd7164d092ff2dc35a123f7b1b6) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2474))
- resource/gitlab_integration_jira:  [Remove `project_key`, use `project_keys` instead](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/f858d3e2554853a5fe320c8546b64e3d2faa573d) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2475))
- datasource/gitlab_project_issues:  [Update `not_assignee_id`, `not_author_id`, `not_my_reaction_emoji` from a list...](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/81c7e93b6191a822cee66125ee17d00fa22733e4) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2473))
- [Removes resource `gitlab_service_github`. Use `gitlab_integration_github` instead.](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/1bbbda9cc7c3829f60945819845b444a3363d84c) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2451))
- [Remove resource `gitlab_service_emails_on_push`. Use `gitlab_integration_emails_on_push` instead.](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/ae7252907a2eb64230b2989f51bdfdf690cd6771) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2444))
- [Remove `force new` requirement when changing project variable environment...](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/8be83d5c696a2bc6240427326ba8068a90a41802) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2443))
- [Removes resource `gitlab_service_jira`. Use `gitlab_integration_jira` instead.](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/53fe58036dd5db6c3d5a3e19712776338d12606b) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2445))
- [Remove `gitlab_service_external_wiki`. Use `gitlab_integration_external_wiki` instead.](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/a9254bcf717537dce60a61e55bbe89e4da93a73d) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2449))
- resource/gitlab_project:  [Remove field `name_regex`, use `name_regex_delete` instead](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/363212cdc515eb1b534aa4cc7306b13451768d9e) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2450))
- [Remove resource `gitlab_service_pipelines_email`. Use `gitlab_integration_pipelines_email` instead.](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/8ab7bf756d843dbd4992a957685a71bcee10ed07) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2453))
- [Remove conditional check for `report_type` based on 17.2. Attempting to use...](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/4c662401e61a7663d93aa8ab1767e5e311cf9c5a) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2446))
- [Remove `access_level`, use `group_access` instead](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/9e612e4aa9f527fa736855f2f477dbb5e58a13b5) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2448))
- [Removes field `soft_delete` as it was replaced by a normal delete in 14.9....](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/849ebcf92fa30c8f3ae5c9d52658b9a746efde16) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2440))
- [Remove application settings deprecated fields (See MR for details of old vs new fields)](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/7d1869f10dcec4ee1035aba68c7a3c3e50fbb2d4) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2442))
- [Remove fields `extern_uid` and `external_provider` from resource...](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/3fbbb21d0db3825814d10d0300795ae31254b186) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2458))
...
- [Add gitlab_integration_redmine resource](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/34acda4593c55be4815cf789df8a009339a9c42f) by @0oMarko0 ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2404))

### IMPROVEMENTS (5 changes)

- resource/gitlab_group:  [Improve top level group note on gitlab_group documentation](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/b813842ee0cd353e71935e5bf8df85634da615c6) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2471))
- resource/gitlab_instance_service_account:  [Add support for `email`](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/2ed92748718f4feb929c3fd485811a614966b4ee) by @bas.bremer ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2423))
- [Add `self_rotate` support to tokens. Using `self_rotate` will use the token to...](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/c758798208f0789cee0aa4b94791123886e9ff94) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2428))
- [Update documentation links](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/a9530855a91221ce4ae27d4dcc69805c74f3132c) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2434))
- [Update documentation links](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/9b61261317257cbe8db1fc0d75c68a004bf76fba) by @heidi.berry ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2435))

### BUG FIXES (1 change)

- [Externally revoked Personal, Group, Project, and Service Account Tokens will...](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/commit/a585f01e0a74b6dd3504820fc106f1d0c1e55af3) ([merge request](https://gitlab.com/gitlab-org/terraform-provider-gitlab/-/merge_requests/2459))
