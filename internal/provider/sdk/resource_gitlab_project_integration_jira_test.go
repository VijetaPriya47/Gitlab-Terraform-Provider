...
func TestAcc_GitlabProjectIntegrationJira_basic(t *testing.T) {
		...
		Steps: []resource.TestStep{
			// Create a project and a jira service
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGitlabProjectIntegrationJiraExists("gitlab_project_integration_jira.jira", &jiraService),
			...
			// Update the jira service
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("gitlab_project_integration_jira.jira", "jira_issue_transition_automatic", "false"),
			...
			// Update the jira service to get back to previous settings
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("gitlab_project_integration_jira.jira", "merge_requests_events", "false"),
					resource.TestCheckResourceAttr("gitlab_project_integration_jira.jira", "use_inherited_settings", "false"),
					resource.TestCheckResourceAttr("gitlab_project_integration_jira.jira", "jira_issue_regex", ""),
					resource.TestCheckResourceAttr("gitlab_project_integration_jira.jira", "issues_enabled", "false"),
					resource.TestCheckResourceAttr("gitlab_project_integration_jira.jira", "jira_issue_transition_automatic", "true"),
				),
			},
			// Verify Import
...
func TestAcc_GitlabProjectIntegrationJira_basic_deprecated(t *testing.T) {
	var jiraService gitlab.JiraService
	project := testutil.CreateProject(t)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create a project and a jira service
			{
				...
				`, project.ID),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGitlabProjectIntegrationJiraExists("gitlab_integration_jira.jira", &jiraService),
...
func TestAcc_GitlabProjectIntegrationJira_projectKey(t *testing.T) {
	var jiraService gitlab.JiraService
	project := testutil.CreateProject(t)
...
func TestAcc_GitlabProjectIntegrationJira_authType_basicAuth(t *testing.T) {
	var jiraService gitlab.JiraService
	project := testutil.CreateProject(t)
...
func TestAcc_GitlabProjectIntegrationJira_authType_tokenAuth(t *testing.T) {
	var jiraService gitlab.JiraService
	project := testutil.CreateProject(t)
...
func testAccCheckGitlabProjectIntegrationJiraExists(n string, service *gitlab.JiraService) resource.TestCheckFunc {
